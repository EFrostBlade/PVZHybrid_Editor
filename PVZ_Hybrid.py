...
def overPlant(f):     
    ...
    if f:
        ...
        data.PVZ_memory.write_bytes(0x0040fe2f,b'\x0f\x81',2)
        ...
        data.PVZ_memory.write_bytes(0x0040fe2f,b'\x0f\x84',2)
        data.PVZ_memory.write_bytes(0x0040e3c6,b'\x85\xd8\x0f\x84\x91\x00\x00\x00',8)
